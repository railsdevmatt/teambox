...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/rack/ssl-enforcer/version.rb", "lib/rack/ssl-enforcer.rb", "lib/rack-ssl-enforcer.rb", "LICENSE", "README.rdoc"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<guard>, ["~> 0.3.0"])
      s.add_development_dependency(%q<guard-test>, ["~> 0.1.6"])
      ...
      s.add_dependency(%q<guard-test>, ["~> 0.1.6"])
