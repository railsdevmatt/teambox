...
Gem::Specification.new do |s|
  ...
  s.files = ["README.textile", "lib/riddle.rb", "lib/riddle/0.9.8.rb", "lib/riddle/0.9.9.rb", "lib/riddle/0.9.9/client.rb", "lib/riddle/0.9.9/client/filter.rb", "lib/riddle/0.9.9/configuration/searchd.rb", "lib/riddle/1.10.rb", "lib/riddle/1.10/client.rb", "lib/riddle/2.0.1.rb", "lib/riddle/2.0.1/client.rb", "lib/riddle/auto_version.rb", "lib/riddle/client.rb", "lib/riddle/client/filter.rb", "lib/riddle/client/message.rb", "lib/riddle/client/response.rb", "lib/riddle/configuration.rb", "lib/riddle/configuration/distributed_index.rb", "lib/riddle/configuration/index.rb", "lib/riddle/configuration/indexer.rb", "lib/riddle/configuration/realtime_index.rb", "lib/riddle/configuration/remote_index.rb", "lib/riddle/configuration/searchd.rb", "lib/riddle/configuration/section.rb", "lib/riddle/configuration/source.rb", "lib/riddle/configuration/sql_source.rb", "lib/riddle/configuration/xml_source.rb", "lib/riddle/controller.rb", "lib/riddle/query.rb", "lib/riddle/query/delete.rb", "lib/riddle/query/insert.rb", "lib/riddle/query/select.rb", "spec/functional/connection_spec.rb", "spec/functional/excerpt_spec.rb", "spec/functional/keywords_spec.rb", "spec/functional/persistance_spec.rb", "spec/functional/search_spec.rb", "spec/functional/status_spec.rb", "spec/functional/update_spec.rb", "spec/riddle/auto_version_spec.rb", "spec/riddle/client_spec.rb", "spec/riddle/configuration_spec.rb", "spec/riddle/controller_spec.rb", "spec/riddle/query/delete_spec.rb", "spec/riddle/query/insert_spec.rb", "spec/riddle/query/select_spec.rb", "spec/riddle/query_spec.rb", "spec/riddle_spec.rb", "spec/spec_helper.rb", "spec/sphinx_helper.rb", "spec/unit/client_spec.rb", "spec/unit/configuration/distributed_index_spec.rb", "spec/unit/configuration/index_spec.rb", "spec/unit/configuration/indexer_spec.rb", "spec/unit/configuration/realtime_index_spec.rb", "spec/unit/configuration/searchd_spec.rb", "spec/unit/configuration/source_spec.rb", "spec/unit/configuration/sql_source_spec.rb", "spec/unit/configuration/xml_source_spec.rb", "spec/unit/configuration_spec.rb", "spec/unit/filter_spec.rb", "spec/unit/message_spec.rb", "spec/unit/response_spec.rb", "spec/unit/riddle_spec.rb"]
